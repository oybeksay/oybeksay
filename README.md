...
*Building high-traffic distributed systems at scale*
...
```
Microservices  ·  Event-Driven Architecture  ·  Distributed Systems  ·  Caching Strategies
```
...
📍 Uzbekistan &nbsp;·&nbsp; Open to exciting backend challenges
